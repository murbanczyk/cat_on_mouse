...
TABLE1          ds      1       ; 31 - Table 1
TABLE2          ds      1       ; 32 - Table 2
TXP2            ds      1       ; 33 - Tx phase 2
NR22             ds      1       ; 34 - Number 22
DELAY6          ds      1       ; 35 - Delay 6
DELAY5          ds      1       ; 36 - Delay 5
TXP3            ds      1       ; 37 - Tx phase 3
WAIT1_0         ds      1       ; 38 - Wait steps 1
WAIT1_1         ds      1       ; 39 - Wait unit1 1
WAIT1_2         ds      1       ; 40 - Wait unit2 1
TXP4            ds      1       ; 41 - Tx phase 4
TXP5            ds      1       ; 42 - Tx phase 5
DELAY2          ds      1       ; 43 - Delay 2
NR1             ds      1       ; 44 - Number 1
TXA2            ds      1       ; 45 - Tx amplitude 2 word 0
TXP6            ds      1       ; 46 - Tx phase 6
...
; Calculate subsequent step length delay
        add     #159,a
        move    a1,a0
        do      r2,LBL3               ; Step the amplitude r2 times
        move    y:(r5)+,a1               ; Load amplitude
        move    a1,x:FPGA_DDS1_Pro0      ; Set amplitude
        move    y:(r4)+,a1               ; Load phase
        move    x:TXP5,y1
