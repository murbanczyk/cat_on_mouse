...
NR333             ds      1       ; 28 - Number 333
TABLE1          ds      1       ; 29 - Table 1
TABLE2          ds      1       ; 30 - Table 2
TXP1            ds      1       ; 31 - Tx phase 1
NR22             ds      1       ; 32 - Number 22
DELAY5          ds      1       ; 33 - Delay 5
DELAY33          ds      1       ; 34 - Delay 33
TXA1            ds      1       ; 35 - Tx amplitude 1 word 0
TXP2            ds      1       ; 36 - Tx phase 2
DELAY1          ds      1       ; 37 - Delay 1
DELAY2          ds      1       ; 38 - Delay 2
NR1             ds      1       ; 39 - Number 1
TXA2            ds      1       ; 40 - Tx amplitude 2 word 0
TXP3            ds      1       ; 41 - Tx phase 3
DELAY3          ds      1       ; 42 - Delay 3
NR2             ds      1       ; 43 - Number 2
DELAY4          ds      1       ; 44 - Delay 4
...
;
        ...
        move    x:NR333,r7                ; Zero NR333*2 points
        clr     a
        do      r7,clearm
        move    a1,y:(r5)+
        move    a1,y:(r5)+
